...
import dayBanner from "../assets/Day.png";
import "../styles/DayShift.css";
...
const pickupTimes = {
  Biratnagar: {
    "Koshi Project": "10:45 AM", "Roadcess": "10:47 AM", "Bus Park": "10:48 AM",
    "Mahendra Chowk": "10:50 AM", "Bhrikuti Chowk": "10:52 AM", "Bargachi": "10:55 AM",
    "Kanchanbari": "11:00 AM", "Oil Nigam": "11:01 AM", "Birat Health": "11:05 AM",
    "Tanki Sinwari": "11:08 AM", "Nemuwa": "11:12 AM", "NIC Asia Duhabi": "11:15 AM",
    "Duhabi": "11:18 AM", "Sonapur": "11:22 AM", "Kadamgacchi": "11:23 AM",
    "Khanar": "11:25 AM", "Reliance": "11:26 AM", "Sathi Petrol Pump": "11:32 AM", "Nabil Bank": "11:35 AM"
  },
  Damak: {
    "Kerkha": "10:00 AM", "Sitapuri": "10:05 AM", "Padajungi": "10:10 AM",
    "Damak Chowk": "10:20 AM", "Urlabari": "10:25 AM", "Aitabare": "10:30 AM",
    "Mangalbare": "10:35 AM", "Pathari": "10:45 AM", "Kanepokhari": "10:55 AM",
    "Bhaunne": "11:00 AM", "Laxmi Marga": "11:05 AM", "Betana": "11:10 AM",
    "Belbari": "11:15 AM", "Lalbhitti": "11:20 AM", "Khorsane": "11:25 AM",
    "BiratChowk": "11:30 AM", "Salakpur": "11:35 AM", "Gothgaun": "11:40 AM"
  },
  Dharan: {
    "BPKIHS": "10:40 AM", "Railway Chowk": "10:48 AM", "Mangalbare": "10:53 AM",
    "Kalyan Chowk": "10:55 AM", "Sami Chowk": "10:58 AM", "Amarhat": "11:00 AM",
    "Bhanu Chowk": "11:05 AM", "Bargachi": "11:10 AM", "Langali Chowk": "11:15 AM",
    "Tarahara": "11:30 AM", "Pipal Chowk": "11:35 AM", "Itahari Chowk": "11:40 AM"
  },
  Inaruwa: {
    "Madhesha": "10:30 AM", "Jhakan Jhora": "10:45 AM", "Balaha": "10:50 AM",
    "Gol Chowk": "11:00 AM", "Mahendra Chowk": "11:02 AM", "Haleshi Chowk": "11:10 AM",
    "Titriban Chowk": "11:15 AM", "Jhumka": "11:20 AM", "Kanchi Chowk": "11:25 AM",
    "Bhatbhateni": "11:27 AM", "Balgram": "11:30 AM", "Pachrukhi": "11:32 AM",
    "Kalanki Chowk": "11:35 AM", "Paragati Chowk": "11:38 AM", "Itahari Chowk": "11:40 AM"
  },
};
...
function DayShift() {
  ...
  const handleProceedToPayment = () => {
    ...
    navigate("/payment", {
      state: { shift: "day", route, busStop: pickup, pickupTime: time }
    });
  };
  ...
  return (
    <div className="shift-page">
      ...
      <div className="shift-banner">
        <img src={dayBanner} alt="Day Shift" className="shift-banner-img" />
        <div className="shift-banner-overlay">
          <span className="shift-label day-label">Day Shift</span>
          <h1>IIC Day Bus Schedule</h1>
          <p>Departure from IIC: <strong>11:00 AM</strong> — Select your route below</p>
        </div>
      </div>
        ...
        {activeTab === "schedule" && (
          <div className="shift-content">
            <div className="form-panel">
              ...
              <p className="form-hint">Choose a route and stop to view your pickup time. Complete payment to register.</p>
            ...
            {route && (
              <div className="schedule-table-panel">
                ...
                <table className="schedule-table">
                  <thead>
                    <tr><th>#</th><th>Bus Stop</th><th>Pickup Time</th></tr>
                  </thead>
                  <tbody>
              ...
              {Object.entries(pickups).map(([r, stops]) => (
                <div className="info-card" key={r}>
                  ...
                  <ul>
                    ...
                    {stops.length > 5 && <li className="more-stops">+{stops.length - 5} more...</li>}
                  </ul>
                </div>
              ))}
            </div>
