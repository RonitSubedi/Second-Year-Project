        ...
        <div className="fb-grid">
          ...
          <div className="fb-tips">
            ...
            <div className="tip-card contact-card">
              ...
              <div className="contact-row"><span><Mail size={14} style={{verticalAlign:"middle",marginRight:4}} />Email</span><strong>transport@iic.edu.np</strong></div>
              <div className="contact-row"><span><Phone size={14} style={{verticalAlign:"middle",marginRight:4}} />Phone</span><strong>025-XXXXXX</strong></div>
